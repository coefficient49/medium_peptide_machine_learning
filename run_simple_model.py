...
seeding_for_reproducibility()
history,model,X_test,y_test,experiment_ID = train_test_model(model_type = "onehot",
                                               conv= True,
                                               rnn = False,
                                               epochs = epochs, 
                                               batch_size = batch_size, 
...
seeding_for_reproducibility()
history,model,X_test,y_test,experiment_ID = train_test_model(model_type = "blosum62",
                                               conv= True,
                                               rnn = False,
                                               epochs = epochs, 
                                               batch_size = batch_size, 
